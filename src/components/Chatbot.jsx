...
const Chatbot = () => {
  ...
  return (
    ...
    <br/>
    <br/>
    <div className="flex flex-col h-[90vh] w-full max-w-4xl mx-auto bg-gradient-to-br from-gray-900 to-gray-800 rounded-2xl shadow-2xl overflow-hidden font-sans">
      {/* Chat Header */}
